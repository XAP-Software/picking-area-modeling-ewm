...
TDC считает кратчайший путь между двумя ячейками, однако из-за того, что таких ячеек в пути может быть много, то влияние эвристики TDC на общий путь будет минимально, следовательно можно опустить то, насколько оптимизирована данная эвристика.
