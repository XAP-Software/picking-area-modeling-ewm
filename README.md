...
3. Внешний вид
4. Приближенность к реальности
5. Надежность технологии -->

| Критерий      | Описание | Вес критерия | Шкала оценки |
| ----------- | ----------- | ----------- | ----------- |
| Производительность | Критерий производительность включает в себя скорость моделирования и обработки данных. Если скорость моделирования и обработки данных низкая, то оценка по критерию производительности также будет низкая.| 3 | 0-10 |
| Сложность разработки   | Критерий сложность разработки включает в себя временную и ресурсную нагрузку реализации задачи. Зависимость между временной и ресурсной нагрузкой и оценкой сложности разработки обратно пропорциональна. То есть при высокой временной и ресурсной нагрузке, оценка по критерию сложность разработки будет низкая. | 4 | 0-10 |
| Внешний вид | Критерий внешний вид отвечает за дизайн во время процесса моделирования, в зависимости от того в каком формате представлено моделирование, оценка по данному критерию будет высокой / низкой. Шкала оценок: моделирование представлено в виде 3D симуляции - оценка высокая, моделирование представлено в виде 2D симуляции или графиков - оценка средняя, моделирование представлено в виде текстовых данных - оценка низкая. | 1 | 0-10 |
| Приближенность к реальности   | Критерий приближенность к реальности включает в себя оценку реализма симуляции и возможность использования продукта в бизнес-сфере. | 5 | 0-10 |
| Надежность технологии | Критерий надежность технологии включает в себя распространенность технологии / платформы и ее поддержку со стороны разработчиков. | 2 | 0-10 |

<!-- #### Описание критериев

Критерий производительность включает в себя скорость моделирования и обработки данных. Если скорость моделирования и обработки данных низкая, то оценка по критерию производительности также будет низкая.

Критерий сложность разработки включает в себя временную и ресурсную нагрузку реализации задачи. Зависимость между временной и ресурсной нагрузкой и оценкой сложности разработки обратно пропорциональна. То есть при высокой временной и ресурсной нагрузке, оценка по критерию сложность разработки будет низкая.

Критерий внешний вид отвечает за дизайн во время процесса моделирования, в зависимости от того в каком формате представлено моделирование, оценка по данному критерию будет высокой / низкой. Шкала оценок: моделирование представлено в виде 3D симуляции - оценка высокая, моделирование представлено в виде 2D симуляции или графиков - оценка средняя, моделирование представлено в виде текстовых данных - оценка низкая.

Критерий приближенность к реальности включает в себя оценку реализма симуляции и возможность использования продукта в бизнес-сфере.

Критерий надежность технологии включает в себя распространенность технологии / платформы и ее поддержку со стороны разработчиков. -->

### Выбор платформы

| Платформа   | Производительность | Сложность разработки | Внешний вид | Приближенность к реальности | Надежность технологии |
| :-----------: | -----------: | -----------: | -----------: | -----------: | -----------: |
| SAP S/4HANA System + Python | 4 | 9 | 4 | 9 | 9 |
| PySim + Python | 9 | 4 | 7 | 6 | 9 |
| AnyLogic + Python | 6 | 8 | 9 | 5 | 5 |

<!-- ### Моделирование в SAP S/4HANA System и обработка результатов в Python  

1. Низкая производительность
2. Низкая сложность разработки
3. Плохой внешний вид
4. Высокая приближенность к реальности
5. Высокая надежность технологии -->
...
2. Высокая сложность разработки
3. Хороший внешний вид
4. Низкая приближенность к реальности
5. Высокая надежность технологии -->
...
<!-- ### Моделирование в AnyLogic и обработка результатов в Python
...
<!-- 1. Плюсы:
    - Реализовано 3D моделирование, 2D моделирование и часть обработки результатов
    - Является готовым продуктом
2. Минусы:
    - Не хватает обязательных параметров (моделирование производится в глобальном виде, т.е. недостаточный уровень детализации)
    - Скорость моделирования низкая -->
