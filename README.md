...
- Количество или размеры областей действий.
...
2. При наличии нескольких складских мест с одинаковой датой срока годности, выбирается ячейка, в которой хранится наименьшее количество продукта.
...
2. Система определяет отпускающие складские места на основе стратегии отбора.
    ...
    2. Среди ячеек с одинаковой датой выхода срока годности обычно выбирается складское место с наименьшим количеством.
    3. Среди ячеек с одинаковым количеством обычно выбирается складское место согласно сортировке по области действий.
